...
DELETE FROM Temporada WHERE id_temporada = 27
...
UPDATE Equipo SET e_nombre = 'Equipo-1', categoria = 'Prueba' WHERE id_equipo = 33
...
alter table Jornada
add constraint jornada_unica UNIQUE(numJornada)
...
create table JPicher(
	...
	jp_legalesEnfrentados int null,
...
WHERE
    e.categoria = 1
GROUP BY 
    e.e_nombre, gd.TotalGanadosContraRival, gd.TotalDiferenciaContraRival
ORDER BY
